...
class QuizResponseSchema:
    ...
    @classmethod
    def get_attribute(
        cls, response_data: Dict[str, Any], question_id: str, attribute: str
    ) -> Any:
    ...
    @classmethod
    def set_attribute(
        cls, response_data: Dict[str, Any], question_id: str, attribute: str, value: Any
    ) -> None:
    ...
    def get_negative_score(
        response_data: Dict[str, Any], question_id: str
    ) -> Optional[float]:
        return (
            response_data.get("responses", {})
            .get(question_id, {})
    ...
    def get_remarks(response_data: Dict[str, Any], question_id: str) -> str:
        return (
            response_data.get("responses", {}).get(question_id, {}).get("remarks", "")
        )

    @staticmethod
    def get_breakdown(response_data: Dict[str, Any], question_id: str) -> str:
        return (
            response_data.get("responses", {}).get(question_id, {}).get("breakdown", "")
        )

    @staticmethod
    def set_student_answer(
        response_data: Dict[str, Any], question_id: str, value: Any
    ) -> None:
    ...
    @staticmethod
    def set_negative_score(
        response_data: Dict[str, Any], question_id: str, value: float
    ) -> None:
        if "responses" not in response_data:
            response_data["responses"] = {}
        if question_id not in response_data["responses"]:
    ...
    @staticmethod
    def set_remarks(
        response_data: Dict[str, Any], question_id: str, value: str
    ) -> None:
        if "responses" not in response_data:
            response_data["responses"] = {}
        if question_id not in response_data["responses"]:

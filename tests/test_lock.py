...
async def test_evaluation_job_with_lock(redis_mock, postgres_mock, mongo_mock):
    ...
    with patch('utils.redisQueue.job.get_redis_client', return_value=redis_mock), \
        ...
        mock_evaluate.return_value = {"status": "success", "message": "Test evaluation complete"}
        quiz_id = "test_quiz_1"
